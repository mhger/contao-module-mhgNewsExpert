...
$GLOBALS['TL_LANG']['tl_module']['newsSorting']['dateAsc'] = array( 'Datum aufsteigend', 'Datum aufsteigend' );
$GLOBALS['TL_LANG']['tl_module']['newsSorting']['dateDesc'] = array( 'Datum absteigend (default)', 'Datum absteigend' );
$GLOBALS['TL_LANG']['tl_module']['newsSorting']['headlineAsc'] = array( 'Titel aufsteigend (A-Z)', 'Titel aufsteigend (A-Z)' );
$GLOBALS['TL_LANG']['tl_module']['newsSorting']['headlineDesc'] = array( 'Titel absteigend (Z-A)', 'Titel absteigend (Z-A)' );
